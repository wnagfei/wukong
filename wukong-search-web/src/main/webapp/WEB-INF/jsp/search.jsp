...
<title>${query} - 商品搜索 - 物空</title>
<meta name="Keywords" content="java,物空java" />
<meta name="description" content="在物空中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://localhost:8074/item/${item.id }.html">
