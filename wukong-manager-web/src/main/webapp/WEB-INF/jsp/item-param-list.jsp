...
<table class="easyui-datagrid" id="itemParamList" title="商品列表"
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'itemCatName',width:100,formatter:formatItemCatName">商品类目</th>
			<th
				data-options="field:'paramData',width:300,formatter:formatItemParamData">规格(只显示分组名称)</th>
			<th
				data-options="field:'created',width:130,align:'center',formatter:WUKONG.formatDateTime">创建日期</th>
			<th
				data-options="field:'updated',width:130,align:'center',formatter:WUKONG.formatDateTime">更新日期</th>
		</tr>
	</thead>
</table>
...
<script>
	function formatItemCatName(value, row, index) {
