...
var jdRecent = {element: $("#recent ul"),jsurl: "http://www.wukong.com/lishiset.aspx?callback=jdRecent.setData&id=",cookiename: "_recent",list: $.cookie("_recent"),url: location.href,init: function() {
...
$.extend(jdModelCallCenter, {autoLocation: function(a) {
    ...
    return pageConfig.navId && "home" == pageConfig.navId && location.href.indexOf("www.wukong.com") >= 0
...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://127.0.0.1:8079/rest/itemcat/all?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.wukong.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
        ...
        b.push('<div class="extra"><a {if pageConfig.isHome}clstag="homepage|keycount|home2013|0614a"{/if} href="http://www.wukong.com/allSort.aspx">\u5168\u90e8\u5546\u54c1\u5206\u7c7b</a></div>'), this.OBJ.attr("load", "1").html(b.join("")), $.bigiframe(this.OBJ), this.FN_GetBrands();
...
!function() {
    pageConfig.FN_ImgError(document), $("img[data-lazyload]").Jlazyload({type: "image",placeholderClass: "err-product"}), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({delay: 50}) : ($("#biz-service").Jdropdown({delay: 50}, function() {
        $.ajax({url: "http://www.wukong.com/hotwords.aspx?position=new-index-002",dataType: "script",scriptCharset: "gb2312",cache: !0})
    }), $("#site-nav").Jdropdown({delay: 50}, function() {
        $.ajax({url: "http://www.wukong.com/hotwords.aspx?position=new-index-003",dataType: "script",scriptCharset: "gb2312",cache: !0})
