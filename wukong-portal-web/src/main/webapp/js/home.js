...
function setArea() {
    ...
    a.def = {text: n,val: i}, e.find("ul").eq(0).after(s.process(a)), t = $("#home-area"), t.Jdropdown({event: "click"}), t.find(".dd ul a[data-id]").click(function() {
        ...
        createCookie("areaId", e, 10, "/;domain=jd.com"), createCookie("ipLoc-djd", e + "-0-0-0", 10, "/;domain=jd.com"), location.href = "http://www.wukong.com/", t.removeClass("hover")
    })
}
...
(function() {
    ...
    $("#virtuals").Jtab({type: "dynamic",index: t,source: "data-url",delay: 200}, function(t, e, i) {
        ...
        return e ? e && e.match(/vclist/) ? pageConfig.FN_GetImageDomain(t) + e : pageConfig.FN_GetImageDomain(t) + "" + e : ""
    ...
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9876\u90e8",fn: function() {
        ...
        var t = $("#shortcut-2013 .fl").eq(0).find(".fore1"), e = '            <li class="fore2 jd-wx-qrcode">                <a href="#none"><i class="i-qrcode"></i>\u5173\u6ce8\u7269\u7a7a</a>                <div class="qrcode-show">                    <span class="arrow">                        <i class="layer1"></i><i class="layer2"></i>                    </span>                </div>            </li>';
