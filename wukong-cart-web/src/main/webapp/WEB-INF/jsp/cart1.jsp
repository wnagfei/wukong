...
<div class="cart-inner">
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
        	...
        	<c:set var="count" value="${count + cart.num}" />
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount">${count }</span> 件商品</div>
        </div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8069/order/order-cart.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去物空国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去物空结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
