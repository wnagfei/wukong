...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8078">
    		<img src="/images/wukong-logo.gif" alt="物空商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span>我已经注册，现在就&nbsp;
        	<a href="http://localhost:8072/page/login" class="flk13">登录</a>
        </span>
        </div>
    </div>
    <div class="mc">
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《物空用户注册协议》</a></label>
                        <span class="clr"></span>
