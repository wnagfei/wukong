...
<div class="w">
    <div id="logo">
    	<a href="http://localhost:8078" clstag="passport|keycount|login|01">
    		<img src="/images/wukong-logo.gif" alt="物空" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://localhost:8078";
						} else {
